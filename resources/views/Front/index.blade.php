                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <h1>{{ json_decode($banner->content)->sub_tittle}}</h1>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            <a href="{{route('frontCatPage',$course->cat->id)}}" class="btn_4">{{$course->cat->name}}</a>
                            <h4>${{$course->price}}</h4>
                            <a href="{{route('frontCoursePage', [$course->cat->id,$course->id])}}"><h3>{{$course->name}}</h3></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="textimonial_iner owl-carousel">
                        @foreach ($testsmonials as $testsmonial )
                        <div class="testimonial_slider">
                            <div class="row">
                                <div class="col-lg-8 col-xl-4 col-sm-8 align-self-center">
                                    <div class="testimonial_slider_text">
                                        <p>{{$testsmonial->desc}}</p>
                                        <h4>{{$testsmonial->name}}</h4>


                                        <h5>{{$testsmonial->spec}}</h5>

                                    </div>
                                </div>
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{asset('uploads/testmonials/'.$testsmonial->img)}}" alt="#">
                                    </div>
                                </div>
                            </div>
                        </div>
